...
class JuniorSuite extends StatelessWidget {
  int index;
  JuniorSuite(this.index):super();

  var BoardController = PageController();
  List<BoardingModel> boarding = [
    BoardingModel(
      image:'assets/images/hotel_room_7.jpg',
    ),
    BoardingModel(
      image:'assets/images/hotel_room_5.jpg',
    ),
    BoardingModel(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          ...
                          FavoriteBox(
                              size: 16,
                              onTap:(){ HotelCubit.get(context).ChangisFavorited(index);},//onTapFavorite,
