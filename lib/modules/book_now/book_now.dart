                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        print (startDate.toString());
                        print (endDate.toString());
                        HotelCubit.get(context).ChangisDate(index, startDate, endDate);
...
class getTimeDateUI extends StatefulWidget {
  const getTimeDateUI({Key? key}) : super(key: key);

  @override
  _getTimeDateUIState createState() => _getTimeDateUIState();
}

class _getTimeDateUIState extends State<getTimeDateUI> {
  int room = 1;
  int ad = 2;
  DateTime startDate = DateTime.now();
  DateTime endDate = DateTime.now().add(Duration(days: 5));
